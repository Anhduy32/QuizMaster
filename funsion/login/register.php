...
// Kiểm tra nếu người dùng nhấn submit form
    ...
    if (empty($ten_dang_nhap) || empty($mat_khau)) {
        ...
        if ($ket_qua_check->num_rows > 0) {
            ...
            if ($chuan_bi_insert->execute()) {
                ...
                // Sửa lại đường dẫn chuyển hướng về đúng thư mục login/login.php của bạn
                echo "<script>
                    setTimeout(function() {
...
<body>
    <div class="main-container">
        <a href="../index.php" class="logo-brand"><i class="fa-solid fa-graduation-cap"></i> QUIZMASTER</a>
                    ...
                    <form class="register-form" id="registerForm" method="POST" action="">
                        ...
                        <div class="form-group terms-group">
                            <label class="terms-label">
                                ...
                                <span>Tôi đồng ý với <a href="#">Điều khoản dịch vụ</a> & <a href="#">Chính sách bảo mật</a></span>
                            </label>
                        </div>
                ...
                <div class="right-content">
                    ...
                    <div class="info-lines">
                        <div class="info-line">
                            ...
                            <span><strong>Thi thử miễn phí:</strong> Thử sức with hàng ngàn đề thi chuẩn cấu trúc từ mọi lĩnh vực.</span>
                        </div>
                        <div class="info-line">
                            <i class="fas fa-share-nodes"></i>
                            <span><strong>Chia sẻ kiến thức:</strong> Tự tạo bộ câu hỏi và đóng góp đề thi của riêng bạn cho cộng đồng.</span>
                        </div>
                        <div class="info-line">
                            <i class="fas fa-chart-line"></i>
                            <span><strong>Theo dõi tiến độ:</strong> Lưu lại kết quả làm bài để đánh giá năng lực cá nhân một cách trực quan.</span>
                        </div>
                    </div>

                    <div class="login-section">
                        <p>Bạn đã có tài khoản từ trước?</p>
                        <a href="login/login.php" class="login-link">Đăng nhập ngay</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        // Lấy dữ liệu đầu vào gồm các ô Text và ô Checkbox điều khoản
        ...
        function checkInputs() {
            ...
            // 1. Kiểm tra xem các ô chữ có bị trống không
            ...
            // 2. Kiểm tra xem ô tích chọn điều khoản đã được tích chưa
            if (!termsCheckbox.checked) {
                allFilled = false;
            }

            // Xử lý bật / tắt trạng thái của nút Đăng ký dựa trên điều kiện thực tế
            if (allFilled) {
        ...
        // Lắng nghe hành vi tích chọn Checkbox điều khoản dịch vụ
        termsCheckbox.addEventListener('change', checkInputs);

        // Kích hoạt quét rà soát ngay khi trang web vừa tải xong lần đầu
        checkInputs();
    </script>
    ...
    <script>
        function checkPasswordStrength(password) {
            ...
            switch(strength) {
                case 0:
                case 1:
                    text = 'Yếu'; width = 30; colorClass = 'strength-weak';
                    break;
                case 2:
                    text = 'Trung bình'; width = 60; colorClass = 'strength-medium';
                    break;
                case 3:
                case 4:
                    text = 'Mạnh'; width = 100; colorClass = 'strength-strong';
                    break;
            }
